process mapBothReads {
    ...
    // original output
    // path "${sampleID}.R1.UNMAPPED.FASTP.FILTERED.hg38.fastq.gz", emit: hg38_fastq
    // path "${sampleID}.R1.UNMAPPED.FASTP.FILTERED.hg38.t2t.fastq.gz", emit: t2t_fastq
    // path "${sampleID}.R1.UNMAPPED.FASTP.FILTERED.hg38.t2t.pangenome.fastq.gz", emit: pangenome_fastq
